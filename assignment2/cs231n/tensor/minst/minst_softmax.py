...
# the first fully connected layer (note: except the last fc layer, they all need to connect with relu)
...
# handle with dropout(随机失活)
keep_prob = tf.placeholder(tf.float32)
h_fc2_drop = tf.nn.dropout(h_fc2, keep_prob)

# the last fc layer without relu
