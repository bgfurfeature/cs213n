...
# x = np.linspace(-0.5, 0.5, num=12).reshape(3, 4)  # [3 x 4]
# # print  x
...
# x = np.random.randn(2, 3, 4)  # [2 x [3 x 4]]
# w = np.random.randn(12, 10)  # [12 x 10]
# b = np.random.randn(10)  # [1 x 10]
# dout = np.random.randn(2, 10)  # [2 x 10]
#
...
# x = 0.001 * np.random.randn(num_inputs, num_classes)   # [N x C] -> [50 x 10]
# y = np.random.randint(num_classes, size=num_inputs)   # [1 x 50]
#
...
# y = np.random.randint(C, size=N)    # [1 x N]
#
# std = 1e-2  # standard variance
